...
# -----------------------------------------------------------------------------
# WORKFLOW DATA INTEGRITY TOOL
# -----------------------------------------------------------------------------
# PURPOSE:
# - --check         : Read-only mismatch scan for workflow readiness
# - --fix-inventory : Writes inventory rows to unblock picking in DEV/TEST
#
# PRODUCTION SAFETY:
# - Do NOT run --fix-inventory in production.
# - --check is read-only and safe for diagnostics.
# -----------------------------------------------------------------------------
