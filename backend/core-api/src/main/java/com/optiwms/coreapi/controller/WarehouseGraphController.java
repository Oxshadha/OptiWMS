...
/**
 * API controller for warehouse graph visualization
 * Returns nodes (racks) and edges (connections) for pathfinding
 */
@RestController
...
public class WarehouseGraphController {
    ...
    /**
     * Get warehouse graph with ALL real racks
     * GET /api/warehouse/graph?warehouseId={id}
