...
const orders = [
  { id: "SO-1001", customer: "Acme Corp", status: "Pending", total: "$426", date: "2025-12-15", items: 12 },
  { id: "SO-1002", customer: "Bright Retail", status: "Shipped", total: "$1,210", date: "2025-12-14", items: 8 },
  { id: "SO-1003", customer: "Delta Mart", status: "Allocated", total: "$980", date: "2025-12-14", items: 15 },
  { id: "SO-1004", customer: "Echo Stores", status: "Delivered", total: "$315", date: "2025-12-13", items: 5 },
  { id: "SO-1005", customer: "Falcon Inc", status: "Pending", total: "$750", date: "2025-12-15", items: 9 },
  { id: "SO-1006", customer: "Global Trade", status: "Shipped", total: "$2,100", date: "2025-12-14", items: 20 },
];
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <h1 className="text-3xl font-bold text-base-content">Orders ({orders.length})</h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        <div className="card bg-base-100 border border-base-300 p-4">
          <div className="flex items-center justify-between">
            <div>
              ...
              <div className="text-2xl font-bold text-base-content">{orders.length}</div>
            </div>
        ...
        <div className="card bg-base-100 border border-base-300 p-4">
          <div className="flex items-center justify-between">
            ...
            <span className="material-symbols-outlined text-3xl text-error">schedule</span>
          </div>
        </div>
        <div className="card bg-base-100 border border-base-300 p-4">
          <div className="flex items-center justify-between">
            ...
            <span className="material-symbols-outlined text-3xl text-info">local_shipping</span>
          </div>
        </div>
        <div className="card bg-base-100 border border-base-300 p-4">
          <div className="flex items-center justify-between">
