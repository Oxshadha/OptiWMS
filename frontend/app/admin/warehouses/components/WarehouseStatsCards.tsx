  ...
  return (
    <>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mt-4">
        <div className="card bg-base-100 border border-base-200 rounded-xl p-5 shadow-sm hover:shadow-md transition-shadow">
          <div className="flex items-center justify-between mb-2">
            <div className="text-sm font-medium text-base-content/70">Active Racks</div>
            <span className="material-symbols-outlined text-success">check_circle</span>
          </div>
          <div className="text-3xl font-bold text-base-content">{stats.activeRacks}</div>
        </div>
        <div className="card bg-base-100 border border-base-200 rounded-xl p-5 shadow-sm hover:shadow-md transition-shadow">
          <div className="flex items-center justify-between mb-2">
            {labelWithHint(
          ...
          <div className="text-3xl font-bold text-base-content">{stats.reservedRacks}</div>
        </div>
        <div className="card bg-base-100 border border-base-200 rounded-xl p-5 shadow-sm hover:shadow-md transition-shadow">
          <div className="flex items-center justify-between mb-2">
            <div className="text-sm font-medium text-base-content/70">Maintenance</div>
            <span className="material-symbols-outlined" style={{ color: "oklch(55% 0.135 66.442)" }}>build</span>
          </div>
          <div className="text-3xl font-bold text-base-content">{stats.maintenanceRacks}</div>
        </div>
        <div className="card bg-base-100 border border-base-200 rounded-xl p-5 shadow-sm hover:shadow-md transition-shadow">
          <div className="flex items-center justify-between mb-2">
          ...
          <div className="text-3xl font-bold text-base-content">{stats.outOfServiceRacks}</div>
        </div>
      </div>
    </>
  );
