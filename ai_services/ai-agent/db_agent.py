...
_REPORT_TRIGGERS = [
    ...
    "export report", "make a pdf report", "generate warehouse report",
    "make report", "build report",
]

def is_report_request(question: str) -> bool:
    q = question.lower()
    return any(trigger in q for trigger in _REPORT_TRIGGERS)
...
def ask_database(question: str):
    ...
    if report_mode:
        try:
            ...
            answer = (
                f"✅ Your report **\"{report_json.get('title', 'Warehouse Report')}\"** is ready!\n\n"
