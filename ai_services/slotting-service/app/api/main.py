"""
main.py — DEAP Genetic Algorithm entry point.
"""
import copy
import uuid
...
if __name__ == "__main__":
    ...
    while True:
        ...
        print(f"  Dimensions     :  {parcel['length']} x {parcel['width']} x {parcel['height']} cm  (L x W x H)")
        print(f"  Volume         :  {parcel['volume_cm3']:,.0f} cm3  ->  {parcel['product_volume']}-volume class")
